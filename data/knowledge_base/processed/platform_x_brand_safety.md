```json
{
  "source_id": "platform_x_brand_safety",
  "title": "X Brand Safety Policy",
  "platform": "x",
  "platform_display": "X",
  "region": "GLOBAL",
  "region_pack": "GLOBAL",
  ...
  "language": "en",
  "source_url": "https://business.x.com/en/help/ads-policies/product-policies/brand-safety-policy",
  "priority": "P1",
  "notes": "Placement and brand safety settings.",
  "raw_file": "data/knowledge_base/raw/platform_x_brand_safety.html",
  "processed_at": "2026-04-10T00:37:24.859484+00:00",
  ...
  "brand_id": "all",
  "block_id": "platform_x_brand_safety",
  "is_global_fallback": true,
  "html_title": "Brand Safety Policy",
  "meta_description": "",
  "canonical_url": "https://business.x.com/en/help/ads-policies/product-policies/brand-safety-policy"
}
```

# X Brand Safety Policy

## Ads Policy: Brand Safety Policy

### **What’s the policy?**

Our brand safety policy builds upon the foundation laid by the X Rules to promote a safe advertising experience for all users and brands. This policy informs the context in which we serve ads, and includes, but is not limited to:
...
In addition to our Brand Safety policies, which help inform ad placement on X, we also have Advertising Policies that determine permissible content in ads and conduct of advertisers on X. Learn more about our Ads Policies [here.](/en/help/ads-policies.html)

###### **How does this policy apply to content monetized through Amplify Pre-Roll?**

The guidelines outlined in the following categories include examples of content not eligible for monetization through the Amplify Pre-Roll Publisher Program. These guidelines apply to all aspects of monetized content, including but not limited to post text, video content, audio, and captions.
...
The above guidelines also apply to content in a newsworthy context, including in relation to time-sensitive events and real-world tragedies. Additionally, content that is considered false or misleading under the [X Rules](https://help.twitter.com/en/rules-and-policies/twitter-rules.html) is not eligible for monetization.

###### **Spam, deceptive, and malicious content**

All publishers that monetize via Amplify Publisher Program must comply with X's platform manipulation and spam rules and [policies.](https://help.x.com/en/rules-and-policies/authenticity.html)
...
- Voice posts and audio recordings with no video/imagery.

For additional guidance on the Amplify Pre-Roll Publisher Program, including account eligibility criteria and information on how these policies are enforced, click [here](/en/help/troubleshooting/amplify-publisher-faqs.html).

For additional Paid Partnership guidance, click [here](https://help.twitter.com/rules-and-policies/paid-partnerships).

[Create your ad](https://ads.twitter.com)
